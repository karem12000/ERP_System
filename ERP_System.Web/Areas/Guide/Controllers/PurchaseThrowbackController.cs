...
namespace ERP_System.Web.Areas.Guide.Controllers
{
    public class PurchaseThrowbackController : Controller
    {
        ...
        public PurchaseThrowbackController(IHttpContextAccessor httpContextAccessor, ProductBll productBll, StockBll stockBll , UnitBll unitBll , PurchaseThrowbackBll invoiceBll)
        {
