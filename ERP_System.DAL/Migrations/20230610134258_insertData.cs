    ...
    public partial class insertData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                INSERT [Page].[Pages] ([ID], [Text], [AreaName], [OrderNo], [IconName], [ControllerName], [CreatedDate], [AddedBy], [ModifiedDate], [ModifiedBy], [IsDeleted], [IsActive], [DeletedDate], [DeletedBy]) VALUES (N'680e0745-ba76-4180-bc58-21247c7d10b5', N'المشتريات', N'Guide', 9, N'fas fa-cart-arrow-down', N'PurchaseInvoice', CAST(N'2023-05-29T13:37:37.3600000' AS DateTime2), NULL, NULL, NULL, 0, 1, NULL, NULL)
